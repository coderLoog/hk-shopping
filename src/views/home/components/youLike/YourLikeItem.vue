  ...
  <div class="wrapper">
    <div class="content" >
      <div class="imageWrapper">
        <div class="is-visible" @click="itemClick">
          <van-image
              class="image"
              :src="goodItem.show.img"
          >
      ...
      <div class="infoWrapper">
        <div class="name">
          <span class="nameText" v-text="goodItem.title"></span>
        </div>
        ...
        <div class="priceWrapper">
          <div class="priceInfo">
            <div class="pricePart">
              <div class="price">
                {{ goodItem.price|moneyFormat }}
              </div>
              <div class="originPrice">{{ goodItem.price|moneyFormat }}</div>
            </div>
          </div>
          <div @click="addToCart(goodItem)" class="iconCartWrapper">
