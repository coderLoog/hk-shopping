...
export const showBack = (callback) => {
    ...
    document.addEventListener('touchstart', () => {
        // passive:true 的作用：表示处理事件函数中不会调用preventDefault函数，减少额外的监听，提高性能
        showBackFunc();
    }, {passive: true});
    // 4. 监听触摸移动
 ...
 * @param {{scrollTop: string}}        target    属性：目标值，必选
